...
<body class="page">
   ...
   <header id="top">
     ...
     <div class="row">
         ...
         <h1 id="logo-text"><a href="index.html" title="">Galéria</a></h1>
       <p id="intro"></p>
     ...
     <div class="row">
         ...
         <ul id="nav" class="nav">
             <li><a href="index.html">Kezdőlap</a></li>
                <li class="current"><a href="galeria.php">Galéria</a></li>
                 <li><a href="feltolt.php">Képek feltöltése</a></li>
             <li class="has-children"><a href="allat.html">Állatvilág</a></li>
